...
class LandlordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create landlord" do
    assert_difference('Landlord.count') do
      post landlords_url, params: { landlord: { email: @landlord.email, first_name: @landlord.first_name, last_name: @landlord.last_name, phone_number: @landlord.phone_number } }
    end
  ...
  test "should update landlord" do
    patch landlord_url(@landlord), params: { landlord: { email: @landlord.email, first_name: @landlord.first_name, last_name: @landlord.last_name, phone_number: @landlord.phone_number } }
